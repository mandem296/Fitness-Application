package com.madfitness.fitness.Ex_alarm;
...
import com.madfitness.fitness.Ex_AbsBootReceiver;
...
public class Ex_AlarmHelper {
    ...
    private PendingIntent getPendingIntent() {
        Intent intent = new Intent("com.madfitness.fitness.alarmmanagerdemo.NOTIFY_ACTION");
